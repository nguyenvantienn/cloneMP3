    ...
    switch(action.type){
        case actionTypes.GET_HOME :
            return {
                ...
                hEditorTheme: action.homeData?.find((item) => item.sectionId === 'hEditorTheme') || null ,
                hEditorTheme2: action.homeData?.find((item) => item.sectionId === 'hEditorTheme2') || null ,
                hEditorTheme3: action.homeData?.find((item) => item.sectionId === 'hEditorTheme3') || null ,
